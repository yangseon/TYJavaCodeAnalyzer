 ...
 */
    final public TypeDeclaration TypeDeclaration() throws ParseException {
        ...
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            case SEMICOLON:
                jj_consume_token(SEMICOLON);
                ret = new EmptyTypeDeclaration(token.beginLine, token.beginColumn, token.endLine, token.endColumn, popJavadoc(), getComments());
                break;
            case ABSTRACT:
            case CLASS:
            case ENUM:
    ...
    final public ClassOrInterfaceDeclaration ClassOrInterfaceDeclaration(Modifier modifier) throws ParseException {
        ...
        {
            if (true) {
                return new ClassOrInterfaceDeclaration(line, column, token.endLine, token.endColumn, popJavadoc(), modifier.modifiers, modifier.annotations, isInterface, name, typePar, extList, impList, members, getComments());
            }
        }
        throw new Error("Missing return statement in function");
    }
    ...
    final public EnumDeclaration EnumDeclaration(Modifier modifier) throws ParseException {
        ...
        {
            if (true) {
                return new EnumDeclaration(line, column, token.endLine, token.endColumn, popJavadoc(), modifier.modifiers, modifier.annotations, name, impList, entries, members, getComments());
            }
        }
        throw new Error("Missing return statement in function");
    }
    ...
    final public EnumConstantDeclaration EnumConstantDeclaration() throws ParseException {
        ...
        {
            if (true) {
                return new EnumConstantDeclaration(line, column, token.endLine, token.endColumn, popJavadoc(), annotations, name, args, classBody, getComments());
            }
        }
        throw new Error("Missing return statement in function");
    }
    ...
    final public BodyDeclaration ClassOrInterfaceBodyDeclaration(boolean isInterface) throws ParseException {
        ...
        if (jj_2_6(2)) {
            ...
            switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                ...
                case SEMICOLON:
                    jj_consume_token(SEMICOLON);
                    ret = new EmptyMemberDeclaration(token.beginLine, token.beginColumn, token.endLine, token.endColumn, popJavadoc(), getComments());
                    break;
                default:
                    jj_la1[29] = jj_gen;
                    jj_consume_token(-1);
    ...
    final public FieldDeclaration FieldDeclaration(Modifier modifier) throws ParseException {
        ...
        {
            if (true) {
                return new FieldDeclaration(line, column, token.endLine, token.endColumn, popJavadoc(), modifier.modifiers, modifier.annotations, type, variables, getComments());
            }
        }
        throw new Error("Missing return statement in function");
    }
    ...
    final public ConstructorDeclaration ConstructorDeclaration(Modifier modifier) throws ParseException {
        ...
        {
            if (true) {
                return new ConstructorDeclaration(line, column, token.endLine, token.endColumn, popJavadoc(), modifier.modifiers, modifier.annotations, typeParameters,
                		name, parameters, throws_, new BlockStmt(bbLine, bbColumn, token.endLine, token.endColumn, stmts), getComments(), imports, pakage);
            }
        }
        throw new Error("Missing return statement in function");
    }
    ...
    final public InitializerDeclaration InitializerDeclaration() throws ParseException {
        ...
        {
            if (true) {
                return new InitializerDeclaration(line, column, token.endLine, token.endColumn, popJavadoc(), isStatic, block, getComments());
            }
        }
        throw new Error("Missing return statement in function");
    }
...
/* Annotation Types. */
    final public AnnotationDeclaration AnnotationTypeDeclaration(Modifier modifier) throws ParseException {
        ...
        {
            if (true) {
                return new AnnotationDeclaration(line, column, token.endLine, token.endColumn, popJavadoc(), modifier.modifiers, modifier.annotations, name, members, getComments());
            }
        }
        throw new Error("Missing return statement in function");
    }
    ...
    final public AnnotationMemberDeclaration AnnotationTypeMemberDeclaration(Modifier modifier) throws ParseException {
        ...
        {
            if (true) {
                return new AnnotationMemberDeclaration(line, column, token.endLine, token.endColumn, popJavadoc(), modifier.modifiers, modifier.annotations, type, name, defaultVal, getComments());
            }
        }
        throw new Error("Missing return statement in function");
    }
