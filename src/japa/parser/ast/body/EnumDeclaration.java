...
public final class EnumDeclaration extends TypeDeclaration {
    ...
    public EnumDeclaration(int beginLine, int beginColumn, int endLine, int endColumn, JavadocComment javaDoc, int modifiers, List<AnnotationExpr> annotations, String name, List<ClassOrInterfaceType> implementsList, List<EnumConstantDeclaration> entries, List<BodyDeclaration> members, List<Comment> comments) {
        super(beginLine, beginColumn, endLine, endColumn, annotations, javaDoc, modifiers, name, members, comments);
        this.implementsList = implementsList;
        this.entries = entries;
    }
