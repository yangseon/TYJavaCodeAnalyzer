...
public final class AnnotationMemberDeclaration extends BodyDeclaration {
    ...
    public AnnotationMemberDeclaration(int beginLine, int beginColumn, int endLine, int endColumn, JavadocComment javaDoc, int modifiers, List<AnnotationExpr> annotations, Type type, String name, Expression defaultValue, List<Comment> comments) {
