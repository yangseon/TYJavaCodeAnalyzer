 ...
 * -. import, package is include argument
 * -. Lamda Range was wrong -> temporally fixed (since 3.2.4) 
 */
/**
...
final class GeneratedJavaParser implements GeneratedJavaParserConstants {
    ...
    private Expression generateLambda(Expression ret, Statement lambdaBody) {
        if (ret instanceof EnclosedExpr) {
             ...
             * BUG Fixed
             * 
             * [#948] I guess LamdaExpr's Range is wrong 
             */
            // ysruy
            //ret = new LambdaExpr(ret.getRange().get(), params, lambdaBody, false);
            // -->
            ret = new LambdaExpr(range(ret.getBegin().get(), lambdaBody.getEnd().get()), params, lambdaBody, false);
 ...
 */
  final public 
CompilationUnit CompilationUnit() throws ParseException {
