 ...
 * -. isAfterLine, isBeforeLine - Judgment of line after or before
 * -. compareLineTo - line compare
 */
/**
...
public class Position implements Comparable<Position> {
    ...
    // ysryu
    /**
     * Judgment of line after
     * @param position
     * @return
     */
    public boolean isAfterLine(Position position) {
        assertNotNull(position);
        if (position.line == Node.ABSOLUTE_BEGIN_LINE) return true;
        if (line > position.line) {
            return true;
    ...
    /**
     * Judgment of line before
     * @param position
     * @return
     */
    public boolean isBeforeLine(Position position) {
        assertNotNull(position);
        if (position.line == Node.ABSOLUTE_END_LINE) return true;
        if (line < position.line) {
            return true;
    ...
    public int compareLineTo(Position o) {
        assertNotNull(o);
        if (isBeforeLine(o)) {
            return -1;
        }
