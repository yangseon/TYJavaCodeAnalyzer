...
/**
 * Modified on 6/5/2017 yangseon ryu(ysryu)
 * -. using excludeComments in public void visit(final ?Type n, final Void arg) 
 * ... exclude comments in printing method type 
 */
/**
...
public class PrettyPrintVisitor implements VoidVisitor<Void> {
    ...
    public void visit(final ClassOrInterfaceType n, final Void arg) {
    	//ysryu
    	if(!this.configuration.isExcludeComments()) {
    		printJavaComment(n.getComment(), arg);
    	}
