...
public class CloneVisitor implements GenericVisitor<Visitable, Object> {
    ...
    public Visitable visit(ConstructorDeclaration n, Object arg) {
        ...
        NodeList<AnnotationExpr> annotations = cloneList(n.getAnnotations(), arg);
        Comment comment = cloneNode(n.getComment(), arg);
        ConstructorDeclaration r = new ConstructorDeclaration(n.getRange().orElse(null), n.getModifiers(), annotations, typeParameters, name, parameters, thrownExceptions, body, null, null);
        r.setComment(comment);
        return r;
    }
    ...
    public Visitable visit(MethodDeclaration n, Object arg) {
        ...
        NodeList<AnnotationExpr> annotations = cloneList(n.getAnnotations(), arg);
        Comment comment = cloneNode(n.getComment(), arg);
        MethodDeclaration r = new MethodDeclaration(n.getRange().orElse(null), n.getModifiers(), annotations, typeParameters, type, name, parameters, thrownExceptions, body, null, null);
        r.setComment(comment);
        return r;
    }
