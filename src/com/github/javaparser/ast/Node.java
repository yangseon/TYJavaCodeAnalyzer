 ...
 * -. get LoC - Range's LoC(total line of code)
 * -. get codeLoc - line of pure code(exclude comment line of code) 
 * -. get complexity
 */
/**
...
public abstract class Node implements Cloneable, HasParentNode<Node>, Visitable, NodeWithRange<Node> {
    ...
    // ysryu
	public final long getLoc() {
		return this.range.getLoC();
	}  
	
	public final long getCodeLoc() {
		return this.codeLoc;
	}  
