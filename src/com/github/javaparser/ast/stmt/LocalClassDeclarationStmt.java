...
public final class LocalClassDeclarationStmt extends Statement {
    ...
    public LocalClassDeclarationStmt(Range range, final ClassOrInterfaceDeclaration classDeclaration) {
        ...
        if (this.classDeclaration != null && this.classDeclaration.getRange().isPresent()) {
        	 this.codeLoc += this.classDeclaration.getCodeLoc();
        	 this.complexity += (this.classDeclaration.getComplexity() - 1);
        	 if(firstNode == null) { 
              	firstNode = this.classDeclaration;
             }
             if(lastNode == null) {
              	lastNode = this.classDeclaration;
             }
         }
