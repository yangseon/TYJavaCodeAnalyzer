...
public final class CatchClause extends Node implements NodeWithBlockStmt<CatchClause> {
    ...
    public CatchClause(final Range range, final Parameter parameter, final BlockStmt body) {
        ...
        // Increase complexity - Exceptions    catch, finally, throw, or throws clause.
        this.complexity++;

        Node firstNode = null, lastNode = null;
        
        if (this.parameter != null && this.parameter.getRange().isPresent()) {
        	this.codeLoc += this.parameter.getCodeLoc();
        	 if(firstNode == null) { 
             	firstNode = this.parameter;
             }
             if(lastNode == null) {
             	lastNode = this.parameter;
             }
        }
